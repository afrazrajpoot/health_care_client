  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-2.5 flex items-center justify-between flex-shrink-0 h-[50px]">
      ...
      <div className="flex gap-2.5">
        <button
          className="border border-blue-600 bg-blue-600 text-white rounded-lg px-2.5 py-1.5 font-semibold text-xs cursor-pointer hover:bg-blue-700 transition-colors"
        ...
        <Link
          href="/dashboard"
          className="border border-gray-200 bg-white rounded-lg px-2.5 py-1.5 font-semibold text-xs cursor-pointer hover:bg-gray-50 transition-colors"
        >
          Dashboard
        </Link>
        <button
